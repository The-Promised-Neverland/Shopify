...
const app = express()
app.use(express.json())  // The express.json() function is a built-in middleware function in Express. It parses incoming requests with JSON payloads and is based on body-parser. In short, this allows us to use req.body to extract json data
