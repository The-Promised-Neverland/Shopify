const products = [
    {
        ...
        description: "Experience the freedom of wireless audio with AirPods - the ultimate earbuds for Apple lovers. With the W1 chip, you'll get unparalleled connectivity and ease of use, while the crystal- clear sound quality will leave you in awe.Plus, the sleek and stylish design is the perfect match for any outfit.Upgrade your listening game today with AirPods.",
        brand: 'Apple',
    ...
    },
    {
        ...
        description: "Never lose your valuables again. Precision tracking with Find My app, easy setup, and sleek design. Attach to anything and have peace of mind.Protect your belongings and give yourself peace of mind with AirTags today.",
        brand: 'Apple',
        category: 'Electronics',
        price: 29,
        countInStock: 0,
    ...
    },
    {
        ...
        description: "Unleash your inner creativity with the Apple Pencil - the ultimate tool for digital artists and designers. With unparalleled precision and accuracy, you can bring your ideas to life in a way that's never been possible before. Whether you're sketching, drawing, or writing notes, the Apple Pencil feels natural and intuitive in your hand. Upgrade your creativity game with the Apple Pencil today.",
        brand: 'Apple',
        category: 'Electronics',
        price: 129,
        countInStock: 189,
    ...
    },
    {
        name: 'Apple TV 4K',
        image: '/images/tv.jpg',
        description: "Experience your favorite shows, movies, and games like never before with Apple TV 4K. With stunning 4K HDR visuals, immersive sound, and a powerful A10X Fusion chip, it delivers the ultimate viewing experience. And with access to all your favorite streaming services and the App Store, there's no shortage of content to choose from. Upgrade your home entertainment system with Apple TV 4K today.",
        brand: 'Apple',
        category: 'Electronics',
        price: 181,
        countInStock: 7081,
    ...
    },
    {
        ...
        description: "Experience the ultimate blend of style and functionality with the Apple Watch. From monitoring your health and fitness to staying connected with loved ones, the Apple Watch Ultra has got you covered. With its sleek and durable design, you can wear it anywhere and everywhere. Make a statement and stay on top of your game with the Apple Watch Ultra.",
        brand: 'Apple',
        category: 'Electronics',
        price: 1200,
        countInStock: 1241,
