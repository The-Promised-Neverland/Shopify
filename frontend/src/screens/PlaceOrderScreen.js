...
const PlaceOrderScreen = () => {
    ...
    // calculate price
    const itemsPrice = addDecimals(cartItems.reduce((acc, eachItem) => acc + eachItem.price * eachItem.quantity, 0));
    ...
    const placeOrderHandler = () => {
        dispatch(createOrder({ // this goes to createOrder action and then sent to addOrder controller
                    ...
                    <Card>
                        <ListGroup variant="flush">
                            ...
                            <ListGroup.Item style={{ display: "contents" }}>
                                <Button style={{ margin: "7px" }} type="button" className="btn-block" disabled={cartItems.length === 0} onClick={placeOrderHandler}>Place Order</Button>
                            </ListGroup.Item>
                        </ListGroup>
                    </Card>
                </Col>
